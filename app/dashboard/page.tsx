...
export default function DashboardPage() {
  ...
  return (
    <div className="container py-6 px-2 sm:px-4 md:px-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight mb-2 sm:mb-0">Dashboard</h1>
        <Button 
          variant="outline" 
      ...
      <Tabs defaultValue="revenue" className="space-y-4">
        <TabsList className="flex flex-wrap">
          <TabsTrigger className="flex-grow text-xs sm:text-sm" value="revenue">Revenue Over Time</TabsTrigger>
          <TabsTrigger className="flex-grow text-xs sm:text-sm" value="products">Revenue by Product</TabsTrigger>
          <TabsTrigger className="flex-grow text-xs sm:text-sm" value="locations">Revenue by Location</TabsTrigger>
          <TabsTrigger className="flex-grow text-xs sm:text-sm" value="profitable">Profitable Products</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="revenue">
          <Card>
            <CardHeader>
              ...
              {showFilters && (
                <div className="mt-4 p-3 sm:p-4 border rounded-md bg-slate-100 dark:bg-slate-800 shadow-md">
            ...
            <CardContent className="h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px]">
              <ChartContainer
                config={{
                  revenue: {
                    label: "Revenue",
