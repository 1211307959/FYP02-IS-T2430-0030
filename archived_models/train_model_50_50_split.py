...
def train_model_with_50_50_split():
    """
    Train an enhanced ethical revenue prediction model using 50/50 split of the dataset.
    Uses improved feature engineering with a fixed model configuration.
    ...
    """
    print("Training revenue model with 50/50 split without target leakage...")
    ...
    train_df, test_df = train_test_split(df_cleaned, test_size=0.5, random_state=42)
    ...
    plt.title('Feature Importance (50/50 Split)')
    plt.tight_layout()
    plt.savefig('feature_importance_50_50_split.png')
    ...
    plt.title('Actual vs Predicted Revenue (50/50 Split)')
    plt.tight_layout()
    plt.savefig('actual_vs_predicted_50_50_split.png')
    ...
    joblib.dump(model_data, 'revenue_model_50_50_split.pkl')
    joblib.dump(encoders, 'revenue_encoders_50_50_split.pkl')
    
    print("\nModel and encoders saved to:")
    print("- revenue_model_50_50_split.pkl")
    print("- revenue_encoders_50_50_split.pkl")
    
    return final_model, encoders, features

if __name__ == "__main__":
    train_model_with_50_50_split() 